...
const ValidatePage = () => {
  ...
  return (
    <><div style={{ backgroundImage: "url(" + background + ")" }} className={styles.bg}> </div><center style={{ color: 'white', marginTop: '10px' }}>
      ...
      <h2><b>Take Picture of Laptop</b></h2>
      <small>Make sure that your Laptop is well aligned with the Camera. This picture will be used for verification purpose.</small>
